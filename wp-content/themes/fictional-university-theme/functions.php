...
{
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyBMnbjSOCXsH82uOYK4rqACBHP1Yy_h6Qc', NULL, 1.0, true);
...
{
    $api['key'] = 'AIzaSyBMnbjSOCXsH82uOYK4rqACBHP1Yy_h6Qc';
    return $api;
}
